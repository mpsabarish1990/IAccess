$(function () {
    ...
    function onQuerySucceeded(sender, args) {
        ...
        currentuserdetails = currentUser.get_id();
        //alert(currentuserdetails);
        jsonvalue = keyCollection["ViewRequest"];
    ...
    function load_DataTable_Values() {
        ...
        if (expand_field_name != undefined) {
            endPointUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('" + obj.listname + "')/items?$select=Modified," + field_name_html + "&$expand=" + expand_field_name + "&$orderby=Modified%20desc&$filter=Requester/Id eq '"+currentuserdetails+"'";
            
        }
        else {
            endPointUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('" + obj.listname + "')/items?$select=Modified," + field_name_html + "&$orderby=Modified%20desc&$filter=Requester/Id eq '" + currentuserdetails + "'";
